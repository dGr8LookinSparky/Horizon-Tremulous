...
vmCvar_t  g_hbuild_dmg;
vmCvar_t  g_abuild_dmg;
...
vmCvar_t  g_buildTimer;

vmCvar_t  g_pathpassword;
vmCvar_t  g_selfknockback;
...
static cvarTable_t   gameCvarTable[ ] =
{
  ...
  { &g_nade_range, "g_nade_range", "192", CVAR_ARCHIVE, 0, qfalse },
  { &g_nade_damage, "g_nade_damage", "310", CVAR_ARCHIVE, 0, qfalse },

  { &g_pathpassword, "g_pathpassword", "", CVAR_ARCHIVE, 0, qfalse },

  { &g_selfknockback, "g_selfknockback", "1000", CVAR_ARCHIVE, 0, qfalse },

  { &g_steepbuild, "g_steepbuild", "0", CVAR_ARCHIVE, 0, qfalse },
  { &g_buildTimer, "g_buildTimer", "1", CVAR_ARCHIVE, 0, qfalse },
  ...
  { &g_unlagged, "g_unlagged", "0", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_deconMode, "g_deconMode", "1", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_adminSayFilter, "g_adminSayFilter", "1", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_jetpackFuel, "g_jetpackFuel", "0", CVAR_ARCHIVE, 0, qfalse  },
  { &g_specNoclip, "g_specNoclip", "0", CVAR_ARCHIVE, 0, qtrue  },
  { &g_freeCredits, "g_freeCredits", "0", CVAR_ARCHIVE, 0, qfalse  },

  { &g_buildMode, "g_buildMode", "1", CVAR_ARCHIVE, 0, qfalse  },

  //rotax
  { &g_ambush_killstonextstage, "g_ambush_killstonextstage", "10", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_dodge, "g_ambush_dodge", "100", CVAR_ARCHIVE, 0, qfalse  },
...
void MoveClientToIntermission( gentity_t *ent )
{
  ...
  if(ent->r.svFlags & SVF_BOT) ent->client->readyToExit = qtrue;
...
void CheckCvars( void )
{
  ...
  if( g_deconMode.modificationCount != lastMarkDeconModCount )
  {
    int       i;
    gentity_t *ent;

    lastMarkDeconModCount = g_deconMode.modificationCount;
